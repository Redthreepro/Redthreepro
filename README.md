...
**Also built:** a [compliance-guarded outreach automation](https://github.com/Redthreepro/outreach-automation-case-study) whose v1 was deliberately held back until the compliance posture was right, then rebuilt on self-hosted n8n and Google Apps Script, where it has run in production since January 2026: 4,019 emails through August, 95% delivered, zero spam complaints; a [file-based operations protocol](https://github.com/Redthreepro/jarvis-ops-protocol-case-study) that keeps scheduled AI agents, background jobs, and my own priorities in sync across projects; a batch video converter; a workstation provisioning installer.
